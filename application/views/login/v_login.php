                    ...
                    <div class="panel-body">
                            <fieldset>          
                             ...
                             // Cetak jika ada notifikasi
                                ...
                                <p>
                                <br>
                                     <button style="float: right;" type="submit" class="btn btn-primary" name="btnSubmit">Login</button>
                                </p>
                           
                                <?php echo form_close();?>
                            </fieldset>
                            <p style="font-size: 12px" align="center">HARAAV Dev - Version : Beta 0.1.1</p>
                    </div>
                </div>
            </div>
        </div>
