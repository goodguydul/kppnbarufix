  <!--  page-wrapper -->
                ...
                <div class="col-lg-10">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Daftar Satuan Kerja Yang Terlambat Menyerahkan BAST
                        </div>
    ...
    foreach ($tampil as $row) {
        ...
        $date3  = date("Y-m-d",strtotime(date("Y-m-d", strtotime($row->tgl_akhir_kontrak)) . " +10 day"));
        $suratt = "";
        if($row->status == 0 && $date1 > $date2 ){
            $status = '<td class="center" align="center"> TERLAMBAT </td>';
            if($date1 > $date3){
                $suratt = '<form action="'.base_url().'middle/cetak_surat_terlambat" method="POST" style="display: inline;">
                                                ...
                                                <div class="modal-dialog" style="width: 300px;">
                                                 <!-- Modal content-->
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <p> <form action="'.base_url().'middle/update_terlambat" method="POST">
...
";?>
<?php 
    $jumlah_terlambat = $no2-1;
    echo '
                    <div class="col-lg-2">
                        <div class="panel panel-primary text-center no-boder">
                            <div class="panel-body red">
                                <i class="fa fa-exclamation-triangle fa-3x"></i>
                                <h3>'.$jumlah_terlambat.' </h3>
                            </div>
                            <div class="panel-footer">
                                <span class="panel-eyecandy-title">Total SatKer Yang Terlambat Menyerahkan BAST
                                </span>
                            </div>
                        </div>
