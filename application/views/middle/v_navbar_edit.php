                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li class="sidebar-search">
                                <!-- search section-->
                                <form class="form-inline" action="'.base_url().'dashboard/cari" method="POST"  >
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li class="sidebar-search">
                                <!-- search section-->
                                <form class="form-inline" action="'.base_url().'dashboard/carikarwas" method="POST"  >
                                    <div class="form-group">
                     ...
                     <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li class="sidebar-search">
                                <!-- search section-->
                                <form class="form-inline" action="'.base_url().'dashboard/editdata" method="POST"  >
                                    <div class="form-group">
                                        <input type="text" name="searchkarwas" class="form-control" placeholder="No Karwas" value="'.$row->no.'" readonly >
                                    </div>
                                    ';
}
?>
